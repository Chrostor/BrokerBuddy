...
namespace BrokerBuddy
{
    public partial class DataWindow : Form
    {
        ...
        private void createLabels1Contact() 
        {
            ...
            CNT2_PN_Type_Label = CreateLabel(397, moveDistY + 36, "CNT2_PN_Type_Label", 25, "Type");
            CNT2_Number_Label = CreateLabel(508, moveDistY + 36, "CNT2_Number_Label", 25, "Number");
            ...
            CNT2_PN1_Type_TB = CreateTextBox(397, moveDistY + 60, 105, 29, "CNT2_PN1_Type_TB", 23);
            CNT2_PN1_Num_TB = CreateTextBox(508, moveDistY + 60, 155, 29, "CNT2_PN1_Num_TB", 24);
            CNT2_PN1_Ext_TB = CreateTextBox(669, moveDistY + 60, 105, 29, "CNT2_PN1_Num_TB", 25);
            CNT2_PN2_Type_TB = CreateTextBox(397, moveDistY + 95, 105, 29, "CNT2_PN2_Type_TB", 26);
            CNT2_PN2_Num_TB = CreateTextBox(508, moveDistY + 95, 155, 29, "CNT2_PN2_Num_TB", 27);
        ...
        private void createLabels2Contact() 
        {
            ...
            CNT3_PN1_Type_TB = CreateTextBox(397, moveDistY + 60, 105, 29, "CNT3_PN1_Type_TB", 34);
            CNT3_PN1_Num_TB = CreateTextBox(508, moveDistY + 60, 155, 29, "CNT3_PN1_Num_TB", 35);
            CNT3_PN1_Ext_TB = CreateTextBox(669, moveDistY + 60, 105, 29, "CNT3_PN1_Num_TB", 36);
            CNT3_PN2_Type_TB = CreateTextBox(397, moveDistY + 95, 105, 29, "CNT3_PN2_Type_TB", 37);
            CNT3_PN2_Num_TB = CreateTextBox(508, moveDistY + 95, 155, 29, "CNT3_PN2_Num_TB", 38);
